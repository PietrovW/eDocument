...
export class InvoiceComponent implements OnInit, OnDestroy {
  ...
  public static readonly DBKeyInvoice = 'todo-demo.invoice_list';
  rows = [];
  rowsCache = [];
  columns = [];
  editing = {};
  ...
  ngOnInit() {
    ...
    this.columns = [
      ...
      { prop: 'name', name: gT('invoice.management.Name'), cellTemplate: this.nameTemplate, width: 200 },
      { prop: 'description', name: gT('invoice.management.Description'), cellTemplate: this.descriptionTemplate, width: 500 },
